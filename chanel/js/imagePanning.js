$.fn.imagePanning=function(){
    ...
    return this.each(function(){
      ...
      $this.data("imagePanning",1)
        ...
        .after("<div class='close-btn'><img src='images/close-icon.png' alt='' /></div><div class='resize' style='position:absolute; width:auto; height:auto; top:0; right:0; bottom:0; left:0; margin:0; padding:0; overflow:hidden; visibility:hidden; z-index:-1'><iframe style='width:100%; height:0; border:0; visibility:visible; margin:0' /><iframe style='width:0; height:100%; border:0; visibility:visible; margin:0' /></div>")
        //image loaded fn
        .one("load",function(){
		...
		.parent().on("mousemove MSPointerMove pointermove",function(e,p){
          var cont=$(this);
          e.preventDefault();
